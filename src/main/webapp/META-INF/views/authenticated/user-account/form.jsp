...
<acme:form>
	...
	<acme:form-phone code="authenticated.user-account.form.label.countryCode" path="phone.countryCode"/>
	<acme:form-phone code="authenticated.user-account.form.label.areaCode" path="phone.areaCode"/>
	<acme:form-phone code="authenticated.user-account.form.label.number" path="phone.number"/>
