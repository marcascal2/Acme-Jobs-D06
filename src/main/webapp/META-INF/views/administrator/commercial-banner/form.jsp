...
<acme:form>
	...
	<acme:form-url code="administrator.commercial-banner.form.label.target" path="target" />
	<acme:form-textbox code="administrator.commercial-banner.form.label.titleHolder" path="titleHolder"/>
	<acme:form-textbox code="administrator.commercial-banner.form.label.creditCardNumber" path="creditCardNumber"/>
	<acme:form-textbox code="administrator.commercial-banner.form.label.month" path="month"/>
	<acme:form-textbox code="administrator.commercial-banner.form.label.year" path="year"/>
	<acme:form-textbox code="administrator.commercial-banner.form.label.cvc" path="cvc"/>
