...
public class AuditorJobController extends AbstractController<Auditor, Job> {
	...
	@Autowired
	private AuditorJobListNonAuditedService	listNonAuditedService;
	...
	private void initialise() {
		...
		super.addCustomCommand(CustomCommand.LIST_NON_AUDITED, BasicCommand.LIST, this.listNonAuditedService);
